...
class CompletedShifts extends StatefulWidget {
  const CompletedShifts({super.key});

  @override
  State<CompletedShifts> createState() => _CompletedShiftsState();
}

class _CompletedShiftsState extends State<CompletedShifts> {
