...
import 'package:sgt_owner/feature/Guards/new_guard/id_card_page/controller/back_image_controller.dart';
import 'package:sgt_owner/feature/Guards/new_guard/id_card_page/controller/front_image_controller.dart';
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  "Front Side",
                                  style: AppFontStyle.mediumTextStyle(Colors.black87,14.sp),
                                ),
                                Obx(
                                  () => SizedBox(
                                      height: 17.h,
                                      child: frontSideController
                                          ...
                                          ? TextButton(
                                              ...
                                              child: Text(
                                                "Remove",
                                                style: AppFontStyle.regularTextStyle(AppColors.primaryColor,14.sp),
                                              ))
                                          : null),
                                )
                              ],
  ...
  Widget buildFrontSide() {
    return Obx(
      () => DottedBorder(
        ...
        padding: EdgeInsets.zero,
        color: frontSideController.selectedImagePath.value == ""
            ? AppColors.grayColor
            : AppColors.white,
  ...
  Widget buildBackSide() {
    return Obx(
      () => DottedBorder(
        dashPattern: const [5, 5],
        padding: EdgeInsets.zero,
        color: backSideController.selectedImagePath.value == ""
            ? AppColors.grayColor
            : AppColors.white,
        radius: Radius.circular(6.r),
        child: SizedBox(
