...
import 'package:sgt_owner/feature/Guards/new_guard/profile_page/controller/profile_controller.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  List<String> _guard = ['Supervisor', 'Guard'];
                  ...
                  () => ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(6.r)),
                          backgroundColor: !profileController.btnEnable.value
  ...
  Widget buildGender() {
    return Form(
      ...
      child: DropdownButtonFormField(
        ...
        validator: (value) {
          return profileController.validateGender(value.toString());
        },
      ),
    );
  }
  ...
  Widget buildGuardPosition() {
    return Form(
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (value) {
          profileController.guardPosition = value!.toString();
        },
        validator: (value) {
          return profileController.validateGuardPosition(value.toString());
        },
      ),
    );
  }
