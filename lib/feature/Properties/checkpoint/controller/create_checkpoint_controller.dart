...
class CreateCheckpointController extends GetxController {
  var currentStep = 0.obs;

  final GlobalKey<FormState> checkpointNameFormKey = GlobalKey<FormState>();
  final GlobalKey<FormState> checkpointDescriptionFormKey =
      GlobalKey<FormState>();
  ...
  late TextEditingController checkpointNameController,
