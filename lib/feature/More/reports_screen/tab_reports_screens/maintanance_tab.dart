...
class MaintananceReportTab extends StatefulWidget {
  const MaintananceReportTab({super.key});

  @override
  State<MaintananceReportTab> createState() => _MaintananceReportTabState();
}

class _MaintananceReportTabState extends State<MaintananceReportTab> {
  ...
  final List<bool> drops = [false, true];
  @override
