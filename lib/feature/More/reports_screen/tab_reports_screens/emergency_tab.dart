...
class EmergencyReportTab extends StatefulWidget {
  const EmergencyReportTab({super.key});

  @override
  State<EmergencyReportTab> createState() => _EmergencyReportTabState();
}

class _EmergencyReportTabState extends State<EmergencyReportTab> {
