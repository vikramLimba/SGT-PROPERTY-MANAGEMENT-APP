...
import 'package:sgt_owner/feature/More/roles_&_permissions/role_&_permission_details/controller/role_&_permission_details_controller.dart';
import 'package:sgt_owner/shared/widgets/custom_appbar.dart';
import 'package:sgt_owner/style/colors.dart';
import 'package:sgt_owner/style/font_style.dart';

class RoleName extends StatefulWidget {
  const RoleName({super.key});

  @override
  State<RoleName> createState() => _RoleNameState();
}
...
class _RoleNameState extends State<RoleName> {
  ...
  final controller = Get.put(RoleNameController());
