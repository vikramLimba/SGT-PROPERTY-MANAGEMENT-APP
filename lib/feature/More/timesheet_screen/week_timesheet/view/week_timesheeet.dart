...
class WeekTimesheet extends StatefulWidget {
  const WeekTimesheet({super.key});

  @override
  State<WeekTimesheet> createState() => _WeekTimesheetState();
}

class _WeekTimesheetState extends State<WeekTimesheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          physics: const BouncingScrollPhysics(), child: weekTimesheet()),
    );
  }

  Widget weekTimesheet() {
    return Column(
      children: [
        Padding(
