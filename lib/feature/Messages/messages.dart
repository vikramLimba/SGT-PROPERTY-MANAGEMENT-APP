...
// import 'package:form_login/messanger/chat_screen/chat_list_screen.dart';
import 'package:get/get.dart';
import 'package:sgt_owner/feature/Messages/widgets/property_chat_listings.dart';
import 'package:sgt_owner/style/colors.dart';
import 'package:sgt_owner/style/font_style.dart';

class AllPropertiesMessages extends StatefulWidget {
  const AllPropertiesMessages({super.key});

  @override
  State<AllPropertiesMessages> createState() => _AllPropertiesMessagesState();
}

class _AllPropertiesMessagesState extends State<AllPropertiesMessages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child: propertiesMessages()),
    );
  }

  Widget propertiesMessages() {
    return Column(
